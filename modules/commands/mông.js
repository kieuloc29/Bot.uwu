...
"https://i.imgur.com/nfWKOFk.jpg",
 ...
 "https://i.imgur.com/FVkLWGP.jpg",
  ...
  var money = data.money
      if(money < 4000) api.sendMessage("Đéo có tiền đòi xem cái lồn, kiếm đủ 4000 đô rồi xem, oke ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 4000})
   var callback = () => api.sendMessage({body:`Bổ mắt nhé😼\n» Số dư: -4000 đô «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
